...
const RenderField = ({field , props} : {field : any , props : CustomProps}) => {
    const {fieldType , iconSrc , iconAlt , placeholder , 
      showTimeSelect , dateFormat , renderSkeleton
    } = props
    switch (fieldType) {
        ...
        case FormFieldType.CHECKBOX:
              return <FormControl className="mb-4">
                <div className="flex items-center ">
                  <Checkbox 
                  id={props.name}
                  checked ={field.value}
                  onCheckedChange={field.onChange} text-xl
                  />
                  <Label htmlFor={props.name} className="checkbox-label ml-5">
